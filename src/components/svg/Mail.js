        ...
        <>
            <svg xmlns="http://www.w3.org/2000/svg" width="36.527" height="36.527" viewBox="0 0 36.527 36.527">
                <g id="Group_1103" data-name="Group 1103" transform="translate(5.264 9.764)">
                    <path id="Path_140" data-name="Path 140" class="-f-icon-bcg" d="M9.132,0H27.4a9.132,9.132,0,0,1,9.132,9.132V27.4A9.132,9.132,0,0,1,27.4,36.527H9.132A9.132,9.132,0,0,1,0,27.4V9.132A9.132,9.132,0,0,1,9.132,0Z" transform="translate(-5.264 -9.764)"/>
